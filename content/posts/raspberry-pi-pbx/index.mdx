---
title: Setting up a PBX on a Raspberry Pi
...
# Setting up a PBX on a Raspberry Pi
...
Before we start setting up our PBX we need to update our RasPBX version and install Fail2Ban.
...
Once you finished setting up your user, you can log in.
